...
- **resumo**: Plataforma que apura o arquétipo de investidor por questionário e devolve alocações ilustrativas por classe de ativos, num enquadramento educativo.
...
- **estado**: ● em produção
- **resumo**: Extensão Chrome que usa IA para resumir Termos de Serviço e Políticas de Privacidade, com classificação de risco e backend seguro.
