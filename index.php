    ...
    <div class="container">
        <div class="archive-hero-content">
            ...
            <div class="archive-hero-text">
                <h1 class="archive-title"><?php esc_html_e( 'Blog', 'atlas-theme' ); ?></h1>
                <div class="archive-description">
                    <p><?php esc_html_e( 'Latest insights, tutorials, and thoughts on web development and technology.', 'atlas-theme' ); ?></p>
                </div>
            </div>
        </div>
    </div>
