    ...
    <div class="container">
        <div class="hero-content">
            <div class="hero-left">
                ...
                ?>
                <p class="hero-role"><?php esc_html_e( 'Archive', 'atlas-theme' ); ?></p>
            </div>
            
            <div class="hero-center">
                <div class="hero-image">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/luis-marques-profile.png' ); ?>" alt="<?php esc_attr_e( 'Archive', 'atlas-theme' ); ?>" class="profile-img">
                </div>
            </div>
            ...
            <div class="hero-right">
                ...
                <div class="stat">
                    <p class="stat-label"><?php esc_html_e( 'Archive Type', 'atlas-theme' ); ?></p>
                    <p class="stat-value"><?php echo esc_html( get_post_type() ?: 'Blog' ); ?></p>
                </div>
            </div>
        </div>
    </div>
